    ...
    return (
        <div className="grid lg:grid-cols-2 items-center gap-3 pt-4">
            {homeEventContent.map((event) => (
                <div key={event.id} className="relative overflow-hidden rounded-lg bg-base-300 grid sm:grid-cols-2 gap-3 p-3 border border-base-content/30">
                    ...
                    <div className="absolute px-4 sm:static md:px-0 z-3 bottom-0 left-0 backdrop-blur-[2px] sm:h-full sm:w-full bg-base-300/80 py-4 md:py-0 flex flex-col justify-center items-center gap-1">
            ...
            <Link href={"/event/info"} className="border border-base-content/30 relative bg-base-300 flex items-center gap-2 justify-center p-3 rounded-lg h-50">
            ...
            <Link href={"/event/new"} className="border border-base-content/30 relative bg-base-300 flex items-center gap-2 justify-center p-3 rounded-lg h-50" >
