...
const Title: React.FC<TitleProps> = ({ title, description, id }) => {
    return (
        <div className="w-full flex justify-end items-center p-3 bg-base-200 rounded-lg md:justify-center" id={id} >
            <div className="relative">
                <div className="custom-card delay3 p-4 backdrop-blur-[5px] bg-base-100 rounded-2xl w-75 md:w-130">
