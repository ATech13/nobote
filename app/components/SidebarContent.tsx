...
const SidebarContent = () => {
    return (
        <div className='flex flex-col py-4 px-2 w-full bg-base-300 rounded-lg'>
            ...
            <p className="text-center text-xs mt-4">Copyright © {new Date().getFullYear()} <span className="font-bold title_gradient cursor-pointer"><a href="https://rartech.ecocinq.com">RARTech</a></span> <br /> Tous les droits sont reservés</p>
        </div>
    )
}
